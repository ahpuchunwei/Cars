...
<link href="__PUBLIC__/style/user_wel.css" rel="stylesheet" type="text/css" />
</head>
...
<div id="main">
    ...
    <div class="con_left">
        ...
        <div class="info">
            ...
            <div class="info_2">
            	<div class="acc">学院：<?php echo ($college); ?></div>
        	...
        	<div class="wel_con">
                ...
                <div class="wel_txt">
                    ...
                    <div class="login_info">
                    	<p class="login_ip">
                        	<span class="ip_now">您本次登录IP：<?php echo ($ip_now); ?></span>
                            <span class="ip_ago">上次登录IP：<?php echo ($ip_ago); ?></span>
                        </p>
                        <p class="login_time">
                        	<span class="time_now">上次登录时间：<?php echo ($time_ago); ?></span>
                        </p>
                    </div>
                    <!--登录信息区域结束-->
                </div>
